...
abstract class V2RayURL {
  ...
  String populateTransportSettings({
    ...
    if (transport == 'tcp') {
      ...
      // Custom transport: xhttp
      // Expecting query like: type=xhttp&path=%2Fmiatohakatashi%3Fed%3D2096&mode=auto
      // Should produce:
      //   "xhttpSettings": { "path": "/miatohakatashi?ed=2096", "mode": "auto" }
      final decodedPath = (path == null || path.isEmpty)
          ? '/'
          : Uri.decodeFull(path);
